...
const HomePage = () => {
        ...
        <>
            ...
            <section className="bg-white py-5">
                <div className="flex flex-col items-center justify-center w-full gap-6">
                    <h2 className="mb text-center text-3xl font-bold">
                        Dịch vụ nổi bật
                    </h2>
                    ...
                    <div className=" flex flex-row justify-center items-center gap-8 w-full max-w-2xl px-4">
                        ...
                        <div className="flex-1  min-w-[150px] max-w-[250px] text-center bg-white py-6 rounded-xl shadow-sm border border-gray-100 cursor-pointer">
                            Rửa xe máy
                        </div>
  ...
  <div className="max-w-6xl mx-auto px-4">
    ...
    <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
      ...
      {/* Cột 1: Giới thiệu App */}
      <div className="flex flex-col gap-4">
        <h3 className="text-2xl font-bold text-white tracking-tight">
          Auto Wash Pro
        </h3>
        <p className="text-sm text-slate-400 leading-relaxed">
          Hệ thống chăm sóc và rửa xe chuyên nghiệp tự động. Mang lại trải nghiệm sạch sẽ, nhanh chóng và an tâm tuyệt đối cho xế yêu của bạn.
        </p>
      </div>

      {/* Cột 2: Đường dẫn nhanh (Links) */}
      <div className="flex flex-col gap-3">
        <h4 className="text-lg font-semibold text-white">Dịch vụ</h4>
        <ul className="space-y-2 text-sm">
          <li><a href="#" className="hover:text-sky-400 transition">Rửa xe máy</a></li>
          <li><a href="#" className="hover:text-sky-400 transition">Chăm sóc & Đánh bóng</a></li>
          <li><a href="#" className="hover:text-sky-400 transition">Đặt lịch trước</a></li>
        </ul>
      </div>
      ...
      <div className="flex flex-col gap-3">
        ...
        <ul className="space-y-2 text-sm text-slate-400">
          <li>📍 Địa chỉ: 643/40 Đường Xô Viết Nghệ Tĩnh Bình Thạnh, TP. Hồ Chí Minh</li>
          <li>📍 Số 7 Đường D1 Phường Tăng Nhơn Phú, TP. Hồ Chí Minh</li>
          <li>📍 Số 1 Đường Lưu Hữu Phước Phường Đông Hòa, TP. Hồ Chí Minh </li>
