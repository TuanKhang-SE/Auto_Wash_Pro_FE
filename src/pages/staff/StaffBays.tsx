        ...
        <div className="flex flex-col gap-6 xl:flex-row xl:items-center xl:justify-between">
          ...
          <div className="grid w-full gap-3 sm:grid-cols-3 xl:w-auto xl:min-w-[470px]">
            <div className="rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-xs font-medium text-blue-100">Ngày theo dõi</p>
              <p className="mt-1 font-bold">
                {new Date(`${today}T00:00:00`).toLocaleDateString("vi-VN")}
              </p>
            </div>

            <div className="rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-xs font-medium text-blue-100">Chờ vào trạm</p>
              <p className="mt-1 text-xl font-bold">{checkedInCount}</p>
            </div>

            <div className="rounded-xl bg-white/10 p-4 backdrop-blur-sm">
              <p className="text-xs font-medium text-blue-100">Chờ check-in</p>
              <p className="mt-1 text-xl font-bold">{waitingCount}</p>
            </div>
        ...
        <aside className="space-y-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h2 className="font-bold text-slate-800">Slot còn lại hôm nay</h2>
